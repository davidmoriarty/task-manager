   ...
   return (
      <div className="w-full max-w-screen-lg mx-auto flex flex-col items-center justify-center gap-y-8 p-4">
         <div className="container mx-auto py-12">
            <h1 className="text-3xl lg:text-4xl text-center font-black tracking-wide leading-relaxed mb-2">
               Task List
            </h1>
            <p className="text-2xl text-center font-medium tracking-wide leading-0 text-gray-800">
         ...
         {inputError && (
            <div
               ...
               className={`bg-rose-200 w-full h-12 flex items-center rounded px-4 -mb-8 shadow-sm transition-opacity duration-500 ${
                  inputError
                     ? "opacity-100 animate-in fade-in zoom-in"
                     : "opacity-0"
               }`}
            >
